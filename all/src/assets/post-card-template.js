...
(function (root, factory) {
    ...
    function renderPostCard(post) {
        ...
        const pinnedBadge = pinned
            ? `<div class="absolute -top-2 -left-2 md:-top-3 md:-left-3 z-10 flex items-center justify-center w-[30px] h-[30px] md:w-9 md:h-9 rounded-full bg-gradient-to-br from-orange-400 to-orange-600 text-white">
                <svg class="text-[15px] md:text-lg" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" width="1em" height="1em"><path d="M22.3126 10.1753L20.8984 11.5895L20.1913 10.8824L15.9486 15.125L15.2415 18.6606L13.8273 20.0748L9.58466 15.8321L4.63492 20.7819L3.2207 19.3677L8.17045 14.4179L3.92781 10.1753L5.34202 8.76107L8.87756 8.05396L13.1202 3.81132L12.4131 3.10422L13.8273 1.69L22.3126 10.1753Z"></path></svg>
               </div>`
            : '';
